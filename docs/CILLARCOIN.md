...
|---------------|------|--------|
| `CillarCoin.sol` | ERC-20 Token Base | Deployed |
| `FareRegistry.sol` | Fare Rules by Region | Testnet |
| `RewardsEngine.sol` | Eco/Usage Rewards | In Progress |
| `DAOManager.sol` | Proposals + Voting | In Design |
| `CillarVesting.sol` | Vesting Lockups | In Design |
| `CivicToken.sol` | Identity Token | Planned |
